    ...
    return (
        ...
        <header className=" bg-white px-4 md:px-20 h-[90px] flex justify-between items-center shadow-lg">
            <div className="flex items-center">
                ...
                <ul className={`md:flex ${isOpen ? 'block' : 'hidden'} z-[1] md:block mt-5 md:mt-0 absolute top-16 left-0 w-full h-full bg-dark  shadow-lg md:static md:bg-transparent md:shadow-none transition duration-700 ease-in-out`}>
