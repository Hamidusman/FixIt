    ...
    return(
        <>
            <section className="bg-secondary px-5 md:px-20 py-5 flex flex-col lg:flex-row justify-between gap-5">
                <article className="bg-white px-5 py-5 rounded-2xl w-full lg:w-[390px]
                                    flex-flex-col ">
            ...
            <h1 className='text-[30px] text-center font-bold my-10'>Professional <span className='text-primary'>Record</span></h1>

            <section className='px-5 md:px-20'>
                <article className='rounded-xl w-full bg-white px-2 lg:px-20 py-5 md:py-10 gap-3 flex flex-col sm:flex-row justify-between'>
