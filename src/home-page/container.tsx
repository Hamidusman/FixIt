...
function Container(){
    return(
        <>
            <section className="bg-secondary px-5 md:px-20 py-5 flex flex-col md:flex-row flex-wrap justify-between gap-5">
                <article className="bg-white px-5 py-5 rounded-2xl w-[390px]
                                    flex-flex-col ">
            ...
            <section className='px-5 md:px-20 mt-10'>
                <article className='rounded-xl w-full bg-white px-20 py: 5 md:py-10 flex flex-col md:flex-row justify-between'>
                    <div className='text-center'>
                        <h1 className='text-[75px] text-primary font-bold '>2</h1>
                        <p className=''>Years of dedicated service</p>
                    </div>
                    <div className='text-center'>
                        <h1 className='text-[75px] text-primary font-bold '>10,000</h1>
                        <p className=''>Jobs Completed</p>
                    </div>
                    <div className='text-center'>
                        <h1 className='text-[75px] text-primary font-bold '>200+</h1>
                        <p className=''>Registered professionals</p>
                    </div>
                    <div className='text-center'>
                        <h1 className='text-[75px] text-primary font-bold '>7</h1>
